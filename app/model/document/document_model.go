...
// arModel is a active record design model for table document operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of document.
	Table = "document"
	// Model is the model object of document.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table document.
	Columns = struct {
		Id           string // 主键ID
		CreateTime   string // 创建时间
		UpdateTime   string // 修改时间
		DeleteTime   string // 删除时间
		IsDelete     string // 0 没有删除 1 删除
		DocumentName string // 标题
		Markdown     string // 内容
		Release      string // 发布内容
		UserId       string // 作者
		Abstract     string // 摘要
